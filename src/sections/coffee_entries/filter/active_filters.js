...
function ActiveFilters({
  ...
  const getTitle = (filterEnum) => {
    switch (filterEnum) {
      case coffeeEnum:
        return (
          <Typography variant="subtitle1">Coffee Filters Applied</Typography>
        );
      case roasterEnum:
        return (
          <Typography variant="subtitle1">Roaster Filters Applied</Typography>
        );
      case originEnum:
        return (
          <Typography variant="subtitle1">Origin Filters Applied</Typography>
        );
      case processEnum:
        return (
          <Typography variant="subtitle1">Process Filters Applied</Typography>
        );
      default:
