...
function CafeRow({ cafe, onCafeDeletion, isUserAuthorized }) {
  const classes = useStyles();
  const { cafe_id, name, city, state, country, website, is_active } = cafe;
...
function CafeData({ cafes, onCafeDeletion, isUserAuthorized }) {
  return (
    <Box pb={2}>
      <Grid container>
        <Grid item xs={12}>
