...
export const selectActiveCafesByUserId = `SELECT * FROM cafes WHERE cafes.user_id = $1 AND cafes.is_active = true`;
...
export const selectCafesByCountry = "SELECT * FROM cafes WHERE country = $1";
